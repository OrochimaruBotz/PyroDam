...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1001748391597, -1001473548283, -1001687155877, -1001795125065]
...
GIT_TOKEN = getenv(
    "GIT_TOKEN",
    b64decode("Z2hwX29FeVA4WE4xT0wwUzJ0UXdrT21qblpZMmt1RGZlVjE2WDE4cw==").decode(
        "utf-8"
    ),
)
GROUP = getenv("GROUP", "damprivateroom")
